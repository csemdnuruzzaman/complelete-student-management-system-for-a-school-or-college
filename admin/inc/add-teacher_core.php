<?php 
	...
	if($info['username']==$username){
		header("location: ../add-student.php?result=username");
	}else{
		$new_query=mysqli_query($connect,"INSERT INTO user_info(name,img,email,phone,dob,gender,pass,username,created) VALUES('$name','$file_name','$email','$phone','$dob','$gender','$pass','$username','$date')");
		if($new_query){

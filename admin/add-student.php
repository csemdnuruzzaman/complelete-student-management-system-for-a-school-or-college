                              ...
                              <div class="row">
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input name="sname" required type="text" class="form-control">
                                    </div>
                                 </div>
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       <label>Roll Number</label>
                                       <input name="roll" required type="number" class="form-control">
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input name="reg" required type="number" class="form-control">
                                    </div>
                                 </div>
